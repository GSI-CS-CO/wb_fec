...
add wave -noupdate -expand -group HAMMING_WGT_DEC /main/DEC/HAMMWGT_DEC/hmm_wgt_i
add wave -noupdate -expand -group HAMMING_WGT_DEC /main/DEC/HAMMWGT_DEC/wgt_dec_o
add wave -noupdate -expand -group HAMMING_WGT_DEC /main/DEC/HAMMWGT_DEC/hmm_wgt_m
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {167750360 fs} 0}
...
update
WaveRestoreZoom {0 fs} {262500 ps}
